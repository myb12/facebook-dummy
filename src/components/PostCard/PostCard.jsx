    ...
    return (
        <div className="post-card">
            <div className='d-flex align-items-center'>
                ...
                <img className="user-image" src="https://scontent.fcgp17-1.fna.fbcdn.net/v/t39.30808-1/291383815_2904595676515391_3804010648147691225_n.jpg?stp=cp0_dst-jpg_p80x80&_nc_cat=106&ccb=1-7&_nc_sid=7206a8&_nc_eui2=AeGQDw1uzQUF0qegEorjuWXFGlqyzIbWXVkaWrLMhtZdWVyhkuMpgYnANHZKLcZqblB-t4Bt2AgJ2bHVyrQOh3yV&_nc_ohc=9vUTzO211jwAX9ClDu-&_nc_oc=AQkUpMP-uEfkkQRx1JYF6MdZ3HsOAXYHqillztecOzuNPJ_NWjL47w3tmX-bFf0jMAw&_nc_ht=scontent.fcgp17-1.fna&oh=00_AT80ZbOJHcaVZw5dUrY8tPStdkKfm7LOcwg27p_G70kJrA&oe=62E33C65" alt="" />

                <div>
                    <div className="author-name">
                        <span>N U Al Quadery</span>
                    </div>
                    <div className="time">
                        <p className='mb-0'>3h</p>
                        <BsDot className='dot' />
                        <MdOutlinePublic />
                    </div>
                </div>
            ...
            <p className="status">
                "প্রেমের টানে আমেরিকার তরুণী চলে এসেছে গাজীপুরে। "
                এরকম একটা নিউজ দেখে আমি সেখানে কমেন্ট করলাম।
                " শা'লা'র কপাল, মানুষের জন্য আমেরিকার তরুণী চলে এসেছে আর আমার জন্য উগান্ডা থেকেও আজ পর্যন্ত কেউ এলো না। "
            </p>
