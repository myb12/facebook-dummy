    ...
    return (
        <div className='main-section-left'>
            <div className='left-first'>
                ...
                {
                    leftData.map((el, i) => <div className="left-item">
                        <img className="left-user" src={el.image} alt={el.title} />
                        <p>
                            {el.title}
                        </p>
                    </div>)
            ...
            <div className="left-footer">
                ...
                {
                    shortcutData.map((el, i) => <div className="left-item">
                        <img className="left-user" src={el.image} alt={el.title} />
                        <p>
                            {el.title}
                        </p>
